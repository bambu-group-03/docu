...
export default function About() {
  return (
    <div>
      <div className="n relative   z-50 flex  items-center justify-center overflow-hidden bg-white ">
        <div className="relative mx-auto h-full px-4  pb-20   sm:max-w-xl md:max-w-full md:px-24 md:pb-10 lg:max-w-screen-xl lg:px-8">
          <div className="flex flex-col items-center justify-between py-16 lg:flex-row">
            <div className=" relative ">
              ...
              <div className="relative z-40 lg:max-w-xl lg:pr-5">
                ...
                <h2 className="text-g1 mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight sm:text-7xl sm:leading-snug">
                  Chasing
                  <span className="border-g4 text-g4 animate__animated animate__flash my-1 inline-block border-b-8 bg-white px-4 font-bold">
                    Innovation
                  </span>
                </h2>
                <p className="text-base text-gray-700">
                  Panda Corp was founded in 2023 by a group of young developers that wanted to make the world a better
                  place.
                </p>
                <div className="mt-10 flex flex-col items-center md:flex-row">
                  <ul className="flex flex-col space-y-6 md:ml-4">
                    <li className="mb-6 flex items-center md:mb-0 md:mr-4">
                      ...
                      />
                      <a
                        href="https://github.com/LuisParedes1"
                        className="mt-3 text-gray-700 hover:text-gray-900 md:mt-0"
                      >
                        Luis Paredes
                      </a>
                    </li>
                    ...
                    <li className="mb-6 flex items-center md:mb-0 md:mr-4">
                      ...
                      />
                      <a
                        href="https://github.com/noxethiems"
                        className="mt-3 text-gray-700 hover:text-gray-900 md:mt-0"
                      >
                        Daniela Vela
                      </a>
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
              <svg
                ...
                className="mx-auto my-6 h-10 w-10 animate-bounce rounded-full bg-white p-2 lg:hidden"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
        ...
        <div className="varien text-g/10 absolute left-1/4 top-6 z-40 hidden text-9xl    ">About Us</div>
        <div className=" absolute -bottom-24 left-10 z-0  opacity-10 ">
          <svg
            width="800px"
            height="800px"
            viewBox="0 0 24 24"
            className="z-0 h-full  w-96    fill-gray-300 object-fill text-gray-300"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
        ...
        <div className=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
          <svg
            ...
            viewBox="0 0 256 256"
            xmlns="http://www.w3.org/2000/svg"
            className="z-0 h-full  w-48 -rotate-90   fill-red-300 object-fill text-red-300"
          >
            <path
        ...
        <div className=" absolute left-3/4 top-10 z-0  opacity-10 ">
          <svg
            fill="#000000"
            width="800px"
            height="800px"
            viewBox="0 0 256 256"
            xmlns="http://www.w3.org/2000/svg"
            className="z-0 h-full  w-96    fill-blue-300 object-fill text-blue-300"
          >
            <path
